...
class AuthorBlogSocialMediaForm extends Component
{
    ...
    public function updateBlogSocialMedia(){
        ...
        $this->blog_social_media->bsm_facebook = $this->facebook_url;
        $this->blog_social_media->bsm_instagram = $this->instagram_url;
        $this->blog_social_media->bsm_youtube = $this->youtube_url;
        $this->blog_social_media->bsm_linkedin = $this->linkedin_url;
        $this->blog_social_media->save();


        if($this->blog_social_media->save()){
